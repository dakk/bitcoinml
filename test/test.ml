...
let keypair_priv_to_wif_test key wif octx =
	Keypair.priv_to_wif key |> assert_equal wif
;;
...
let suite = "bitcoinml" >::: [
	...
	"script.spendable_by"	>:: script_spendable_by_test
		...
		"keypair.key_to_wif"	>:: keypair_priv_to_wif_test (Hex.to_string (`Hex "0C28FCA386C7A227600B2FE50B7CAE11EC86D3BF1FBE471BE89827E19D72AA1D")) "5HueCGU8rMjxEXxiPuD5BDku4MkFqeZyd4dZ1jvhTVqvbTLvyTJ";
		"keypair.wif_to_key"	>:: keypair_priv_to_wif_test (Hex.to_string (`Hex "0C28FCA386C7A227600B2FE50B7CAE11EC86D3BF1FBE471BE89827E19D72AA1D")) "5HueCGU8rMjxEXxiPuD5BDku4MkFqeZyd4dZ1jvhTVqvbTLvyTJ";
		"keypair.from_priv"	>:: keypair_from_priv_test (Hex.to_string (`Hex "0C28FCA386C7A227600B2FE50B7CAE11EC86D3BF1FBE471BE89827E19D72AA1D")) "1GAehh7TsJAHuUAeKZcXf5CnwuGuGgyX2S";
];;
