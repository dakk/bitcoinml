...
let merkle_of_hashes_test hl mr octx =
	assert_equal 
		(Hex.to_string mr) @@ Block.Merkle.of_hashes (List.map (fun x -> Hex.to_string x) hl)
;;
...
let suite = "bitcoinml" >::: [
	...
	"script.to_string" >:: script_to_string_test
		...
		"((OP_DUP OP_HASH160(OP_DATA 20\"\\137\\171\\205\\239\\171\\186\\171\\186\\171\\186\\171\\186\\171\\186\\171\\186\\171\\186\\171\\186\")OP_EQUALVERIFY OP_CHECKSIG)25)";
	...
	"tx.to_string" >:: tx_to_string_test
		(`Hex "")
		"((hash c7736a0a0046d5a8cc61c8c3c2821d4d7517f5de2bc66a966011aaa79965ffba)(version 1)(txin(((out_hash 3f4fa19803dec4d6a84fae3821da7ac7577080ef75451294e71f9b20e0ab1e7b)(out_n 0)(script(((OP_DATA 72\"0E\\002!\\000\\137I\\240\\203@\\000\\148\\173+^\\179\\153\\213\\157\\001\\193Ms\\216\\254n\\150\\223\\026qP\\222\\179\\136\\171\\1375\\002 ye`\\144\\215\\246\\186\\196\\201\\169N\\n\\1731\\026Bh\\224\\130\\167%\\248\\174\\174\\005s\\251\\018\\255\\134j_\\001\"))73))(sequence -1))))(txout(((value 4999990000)(script((OP_DUP OP_HASH160(OP_DATA 20\"\\203\\194\\nvd\\242\\246\\158SU\\170BpE\\188\\021\\231\\198\\199r\")OP_EQUALVERIFY OP_CHECKSIG)25)))))(locktime 0)(size 158))";
	...
	"block.merkle.of_hashes" >:: merkle_of_hashes_test [`Hex "ca978112ca1bbdcafac231b39a23dc4da786eff8147c4e72b9807785afee48bb"; `Hex "3e23e8160039594a33894f6564e1b1348bbd7a0088d42c4acb73eeaed59c009d"] (`Hex "029fd80ca2dd66e7c527428fc148e812a9d99a5e41483f28892ef9013eee4a19");
];;
