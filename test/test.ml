...
let block_parse_test raw octx =
	...
	match bl with
	| None -> assert_equal true false
	| Some (b) -> assert_equal true true
;;

let keypair_priv_to_wif_test key wif octx =
	Hex.to_string key |> Keypair.priv_to_wif |> assert_equal wif
;;

let keypair_wif_to_priv_test key wif octx =
	Keypair.wif_to_priv wif |> assert_equal key
;;

let keypair_verify_test pk msg signature result octx =
	assert_equal result @@
		Keypair.verify (Hex.to_string pk) (Hex.to_string msg) (Hex.to_string signature) 
;;

let keypair_from_priv_test key adr octx =
	match Keypair.from_priv (Hex.to_string key) with
...
let suite = "bitcoinml" >::: [
	...
	"script.spendable_by"	>:: script_spendable_by_test
		...
		"keypair.key_to_wif"	>:: keypair_priv_to_wif_test (`Hex "0C28FCA386C7A227600B2FE50B7CAE11EC86D3BF1FBE471BE89827E19D72AA1D") "5HueCGU8rMjxEXxiPuD5BDku4MkFqeZyd4dZ1jvhTVqvbTLvyTJ";
		"keypair.wif_to_key"	>:: keypair_priv_to_wif_test (`Hex "0C28FCA386C7A227600B2FE50B7CAE11EC86D3BF1FBE471BE89827E19D72AA1D") "5HueCGU8rMjxEXxiPuD5BDku4MkFqeZyd4dZ1jvhTVqvbTLvyTJ";
		"keypair.from_priv"	>:: keypair_from_priv_test (`Hex "0C28FCA386C7A227600B2FE50B7CAE11EC86D3BF1FBE471BE89827E19D72AA1D") "1GAehh7TsJAHuUAeKZcXf5CnwuGuGgyX2S";
		"keypair.verify" >:: keypair_verify_test 
			(`Hex "040A629506E1B65CD9D2E0BA9C75DF9C4FED0DB16DC9625ED14397F0AFC836FAE595DC53F8B0EFE61E703075BD9B143BAC75EC0E19F82A2208CAEB32BE53414C40")
			(`Hex "CF80CD8AED482D5D1527D7DC72FCEFF84E6326592848447D2DC0B0E87DFC9A90")
			(`Hex "3044022079BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F817980220294F14E883B3F525B5367756C2A11EF6CF84B730B36C17CB0C56F0AAB2C98589")
			true;
		"keypair.verify2" >:: keypair_verify_test 
			(`Hex "040a629506e1b65cd9d2e0ba9c75df9c4fed0db16dc9625ed14397f0afc836fae595dc53f8b0efe61e703075bd9b143bac75ec0e19f82a2208caeb32be53414c40")
			(`Hex "CF80CD8AED482D5D1527D7DC72FCEFF84E6326592848447D2DC0B0E87DFC9A91")
			(`Hex "3044022079BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F817980220294F14E883B3F525B5367756C2A11EF6CF84B730B36C17CB0C56F0AAB2C98589")
			false;
];;
